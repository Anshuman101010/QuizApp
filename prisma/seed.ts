...
async function main() {
  // Remove all users for a clean slate
  await prisma.users.deleteMany({})
  console.log('All users deleted.')

  // Ensure all users have password123
  const users = [
